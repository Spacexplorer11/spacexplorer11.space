...
>
	<div class="mt-20 flex max-w-3xl flex-col items-start sm:items-center sm:text-center">
		...
		<h1 class="title mb-2 max-w-xl text-5xl text-orange-950 sm:text-6xl">
			I&apos;m Akaalroop (spacexplorer11) a coder.{" "}
		</h1>
		<p class="max-w-lg opacity-90 sm:text-xl">
			With a big passion for building things, I&apos;m always looking for new opportunities to learn
			and grow.
		</p>
